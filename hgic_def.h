...
#define VERSOIN_SHOW(name) do{\
        printk("** HUGE-IC WLAN Card Driver("name") "HGIC_VERSION"-"SVN_VERSION", build time:"__DATE__" "__TIME__"\r\n");\
    }while(0)
...
struct hgic_bus {
    ...
    int (*tx_ctrl)(void *bus, struct sk_buff *skb);
...
#define LINUX_VERSION_CODE KERNEL_VERSION(5, 11, 14)
