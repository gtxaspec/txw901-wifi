...
struct hgic_fwctrl {
    ...
    struct work_struct  rx_work;  /*fw ctrl rx packet process rx_work*/
    struct work_struct  tx_work;  /*fw ctrl tx work*/
    struct workqueue_struct *rx_wq;
    struct workqueue_struct *tx_wq;
    u8                  qc_mode:1, icmp_mntr:1, remove:1, throughput:2;
    u8                  radio_onoff;
    struct hgic_fw_info *fwinfo;
    struct hgic_bus *bus;
    u16  (*data_cookie)(void *priv);
...
int hgic_fwctrl_set_coexist_en(struct hgic_fwctrl *ctrl, u8 ifidx, u8 data[3]);
